        ...
        <section className="box-border py-12 sm:py-16 md:py-20 bg-[#181716]">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col gap-2 sm:gap-3 md:gap-4 items-center justify-center text-center">
                    ...
                    <p className="w-full sm:w-4/5 md:w-3/4 lg:w-2/3 xl:w-[500px] text-sm sm:text-base md:text-lg lg:text-xl text-primary font-light text-center pb-4 sm:pb-6 md:pb-8">
                    ...
                    <a 
                        ...
                        className="bg-primary text-black px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base md:text-lg inline-block hover:bg-opacity-90 transition duration-300"
                    >
                        Schedule a Meeting
                    </a>
                </div>
