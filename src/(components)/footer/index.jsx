                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-end items-center space-y-4 sm:space-y-0">
                        <a
                            ...
                            className="bg-[#DAC5A70D] backdrop-filter backdrop-blur-sm text-primary px-2 py-1.5 sm:px-3 sm:py-1.5 rounded hover:bg-[#DAC5A726] transition duration-300 flex items-center justify-center space-x-2 border border-[#DAC5A733] text-sm"
                        >
                            <div className="rounded-full bg-[#DAC5A726] p-1 flex items-center justify-center">
                                <svg
                            ...
                            <span className="hidden sm:inline text-sm">
                                {isHovered ? "+880 1306-409978" : "Direct Message"}
                            </span>
                            <span className="sm:hidden text-sm">Direct Message</span>
                        </a>
                    </div>
                    {/* Social Media Links */}
                    <div className="flex flex-wrap justify-center gap-4 sm:gap-8">
                        {[
                            ...
                            {
                                href: "https://www.linkedin.com/in/seeamahmod/",
                                label: "LinkedIn",
                            ...
                            {
                                href: "https://x.com/seeam_ahmod",
                                label: "Twitter",
                                iconPath: "M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"
                            },
                            {
                                href: "https://www.behance.net/seeamahmod",
                                label: "Behance",
                                iconPath: "M4.654 3c.461 0 .887.035 1.278.14.39.07.711.216.996.391.286.176.497.426.641.747.14.32.216.711.216 1.137 0 .496-.106.922-.356 1.242-.215.32-.566.606-.997.817.606.176 1.067.496 1.348.922.281.426.461.957.461 1.563 0 .496-.105.922-.285 1.278a2.317 2.317 0 0 1-.782.887c-.32.215-.711.39-1.137.496a5.329 5.329 0 0 1-1.278.176L0 12.803V3h4.654zm-.285 3.978c.39 0 .71-.105.957-.285.246-.18.355-.497.355-.887 0-.216-.035-.426-.105-.567a.981.981 0 0 0-.32-.355 1.84 1.84 0 0 0-.461-.176c-.176-.035-.356-.035-.567-.035H2.17v2.31c0-.005 2.2-.005 2.2-.005zm.105 4.193c.215 0 .426-.035.606-.07.176-.035.356-.106.496-.216s.25-.215.356-.39c.07-.176.14-.391.14-.641 0-.496-.14-.852-.426-1.102-.285-.215-.676-.32-1.137-.32H2.17v2.734h2.305v.005zm6.858-.035c.286.285.711.426 1.278.426.39 0 .746-.106 1.032-.286.285-.215.46-.426.53-.64h1.74c-.286.851-.712 1.457-1.278 1.848-.566.355-1.243.566-2.06.566a4.135 4.135 0 0 1-1.527-.285 2.827 2.827 0 0 1-1.137-.782 2.851 2.851 0 0 1-.712-1.172c-.175-.461-.25-.957-.25-1.528 0-.531.07-1.032.25-1.493.18-.46.426-.852.747-1.207.32-.32.711-.606 1.137-.782a4.018 4.018 0 0 1 1.493-.285c.606 0 1.137.105 1.598.355.46.25.817.532 1.102.958.285.39.496.851.641 1.348.07.461.105.957.07 1.492h-4.782c0 .496.175.927.461 1.297z"
                            },
                            {
                                href: "https://dribbble.com/seeamahmod",
                                label: "Dribbble",
                                iconPath: "M8 0C3.584 0 0 3.584 0 8s3.584 8 8 8c4.408 0 8-3.584 8-8s-3.592-8-8-8zm5.284 3.688a6.802 6.802 0 0 1 1.545 4.251c-.226-.043-2.482-.503-4.755-.217-.052-.112-.096-.234-.148-.355-.139-.33-.295-.668-.451-.99 2.516-1.023 3.662-2.498 3.81-2.69zM8 1.18c1.735 0 3.323.65 4.53 1.718-.122.174-1.155 1.553-3.584 2.464-1.12-2.056-2.36-3.74-2.551-4A6.95 6.95 0 0 1 8 1.18zm-2.907.642A43.123 43.123 0 0 1 7.627 5.77c-3.193.85-6.013.833-6.317.833a6.865 6.865 0 0 1 3.783-4.78zM1.163 8.01V7.8c.295.01 3.61.053 7.02-.971.199.381.381.772.555 1.162l-.27.078c-3.522 1.137-5.396 4.243-5.553 4.504a6.817 6.817 0 0 1-1.752-4.564zM8 14.837a6.785 6.785 0 0 1-4.19-1.44c.12-.252 1.509-2.924 5.361-4.269.018-.009.026-.009.044-.017a28.246 28.246 0 0 1 1.457 5.18A6.722 6.722 0 0 1 8 14.837zm3.81-1.171c-.07-.417-.435-2.412-1.328-4.868 2.143-.338 4.017.217 4.251.295a6.774 6.774 0 0 1-2.924 4.573z"
                            }
                            // Add more social links here (LinkedIn, Twitter, Behance, Dribbble) in similar format
                        ].map((social, index) => (
                            <a
                                key={index}
                                href={social.href}
                    ...
                    <div className="flex justify-center items-center pt-4">
                        <p className="text-[1.25rem] font-solenoidal">
                            &copy; SEEAM AHMOD 2024 ALL RIGHTS RESERVED
                        </p>
                    </div>
                </div>
            </section>
